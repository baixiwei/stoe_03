...
function getPracticeBlock( topic, spatial, temporal, mask, mode ) {
    ...
    if ( topic=="Binomial" ) {
        questions = [
            ...
            { "quesID": 1,
              "text": "<p>The peak of the graph is always located over the single most likely result, and its height indicates the likelihood that result will actually occur.  The next few questions will ask you to use the sliders to fix the location and height of the peak.</p><p>Click <b>SUBMIT</b> to continue.</p>" },
            { "quesID": 2,
            ...
            { "quesID": 17,
              "text": "<p>In the next section, you'll be asked some questions to test your understanding of how the number of repetitions and probability of success affect the shape of the distribution.</p><p>The interactive graph will <b>not</b> be available to help, so play around with it more if you like, then click <b>SUBMIT</b> when you're ready to go on.</p>" }
            ];
    // power law of practice
        ...
        questions = [
            ...
            { "quesID": 1,
              "text": "<p>The height of the graph on the y-axis for each point on the x-axis shows you what the response time will be after each number of trials.  The next few questions will ask you to use the sliders to control the response times.</p><p>Click <b>SUBMIT</b> to continue.</p>" },
            { "quesID": 2,
            ...
            { "quesID": 5,
              "text": "<p>The 'steepness' of the graph shows you how fast response times are decreasing as the number of trials increases.  The next few questions will ask you to use the sliders to control how fast response times decrease.</p><p>Click <b>SUBMIT</b> to continue.</p>" },
            { "quesID": 6,
            ...
            { "quesID": 10,
              "text": "<p>Besides looking at <b>HOW MUCH</b> response time decreases, it's also important to look at the <b>PERCENT or RATIO</b> by which response time decreases.  The next few questions will ask you to use the sliders to control this ratio.</p><p>Click <b>SUBMIT</b> to continue.</p>" },
            { "quesID": 11,
            ...
            { "quesID": 14,
              "text": "<p>Depending on the initial time and learning rates of different people, one person might start out slower than another person but later become faster, or one person might <b>always</b> be faster than another. The next questions will ask you to compare the graphs for different people.</p><p>Click <b>SUBMIT</b> to continue.</p>" },
            { "quesID": 15,
            ...
            { "quesID": 19,
              "text": "<p>In the next section, you'll be asked some questions to test your understanding of how the inital time and learning rate affect the shape of the distribution.</p><p>The interactive graph will <b>not</b> be available to help, so play around with it more if you like, then click <b>SUBMIT</b> when you're ready to go on.</p>" }
            ];
    }
    for ( var i=0; i<questions.length; i++ ) {
        ...
        if ( (i!=0) && (questions[i].key!=undefined) ) {
...
function getTestBlock( topic, mode ) {
    ...
    var data = [];
    for ( var i=0; i<specs.length; i++ ) {
        data.push( { "section": "Test", "topic": topic, "number": i, "stimID": specs[i].quesID } );
